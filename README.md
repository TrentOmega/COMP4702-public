...
- `lectures/` is populated with 12 week folder(s) and 51 non-placeholder file(s).
- `pracs/` (not public) is populated with 12 week folder(s) and 43 non-placeholder file(s).
